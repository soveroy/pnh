  ...
  return (
    <aside className="w-16 h-full border-r border-neutral-800 flex flex-col items-center py-4 shrink-0 bg-neutral-900">
      ...
      <nav className="flex flex-col gap-4 w-full px-2 flex-1">
        <Link 
          href="/dashboard" 
          className={`h-10 w-full rounded flex items-center justify-center transition-colors ${pathname?.startsWith('/dashboard') ? 'bg-neutral-800 text-neutral-200' : 'text-neutral-500 hover:bg-neutral-800 hover:text-neutral-300'}`}
        ...
        <Link 
          href="/compliance" 
          className={`h-10 w-full rounded flex items-center justify-center transition-colors ${pathname?.startsWith('/compliance') ? 'bg-neutral-800 text-neutral-200' : 'text-neutral-500 hover:bg-neutral-800 hover:text-neutral-300'}`}
          title="Privacy & Compliance (PDPA & HITL)"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
